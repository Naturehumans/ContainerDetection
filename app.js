...
const REF_LON = 106.88171;
const REF_LAT = -6.11249;
...
const buildingPoints = {
    ...
    D: [106.88190, -6.11250],
    E: [106.88178, -6.11258],
    F: [106.88171, -6.11249] // Reference point
};
...
// Check if a rectangle is inside the polygon (using center point for better tolerance on skewed GPS edges)
function isRectInPolygon(rx, ry, rw, rh, poly) {
    // Check center of the container
    const cx = rx + rw / 2;
    const cy = ry + rh / 2;
